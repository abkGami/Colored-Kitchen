  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        {cartItems.map((item) => (
          <div key={item.product.id} className="grid grid-cols-1 md:grid-cols-12 gap-4 py-6 border-b border-gray-200">
            <div className="col-span-6 flex gap-4">
              ...
              <div>
                ...
                <span className="text-sm text-gray-500 capitalize">{item.product.category}</span>
                <button 
