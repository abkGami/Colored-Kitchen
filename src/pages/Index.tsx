    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="relative rounded-xl overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 flex flex-col justify-center z-20 px-6 md:px-12">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">Kitchen Utensil Emporium</h1>
          <p className="text-lg text-white/90 max-w-md mb-6">
            Discover our premium collection of kitchen utensils designed to make your cooking experience exceptional.
          </p>
          <div>
            <Link to="/products">
